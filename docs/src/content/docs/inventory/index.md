...
1. The [Release workflow](/trusted-base-images/reference/architecture/) promotes images to the `trusted` or `quarantine` namespace
...
| Image | Status Page |
|-------|------------|
| UBI9 Standard | [Inventory](/trusted-base-images/inventory/ubi9-standard/) |
| UBI9 Minimal | [Inventory](/trusted-base-images/inventory/ubi9-minimal/) |
